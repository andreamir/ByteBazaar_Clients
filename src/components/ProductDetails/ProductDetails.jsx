...
function ProductDetails(props){
  ...
  <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
    ...
    <div className="col-lg-4 p-0 overflow-hidden shadow-lg order-lg-1">
      <div className="lc-block"><img className="rounded-start w-100" src={`${product.gameTitle_id.image}`}
       alt={`"${product.gameTitle_id.title}"`} width="720"></img></div>
    </div>

    <div className="col-lg-7 p-3 p-lg-5 pt-lg-3 order-lg-2">
      <div className="lc-block mb-3">
        <div editable="rich">
          <h2 className="fw-bold display-4">{product.gameTitle_id.title}<p></p><p></p></h2>
        </div>
      </div>
